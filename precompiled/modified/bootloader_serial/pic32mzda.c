...
int board_early_init_f(void)
{
	...
	/* PPS for U2 RX/TX */
	writel(0x02, RPF12R); /* G9 */					// Used to be: writel(0x02, RPG9R);
	writel(0x01, U4RXR); /* B0 */					// Used to be: writel(0x05, U2RXR);
	writel((1 << 9), ANSELCLR(PIC32_PORT_G)); /* digital mode */	// Used to be: writel(0x01, ANSELCLR(PIC32_PORT_B));
